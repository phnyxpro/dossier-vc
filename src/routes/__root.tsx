    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          >
            {user ? t("nf.dashboard") : t("nf.signin")}
          </Link>
          <Link
            to="/portal"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dossier by Ventureble — Capital Readiness for Caribbean MSMEs" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Dossier by Ventureble" },
      {
        ...
        content: "AI-assisted capital readiness and lender-pack preparation for Caribbean businesses.",
      },
